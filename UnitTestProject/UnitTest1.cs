...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        // Custom test methods for colour class
        #region
        [TestMethod]
        public void ColourCustomTest1()
        {
            // Check maximum colour value
            Colour c = new Colour(0xFF, 0xFF, 0xFF, 0xFF);

            Assert.AreEqual<UInt32>(4294967295, c.colour);
        }

        [TestMethod]
        public void ColourCustomTest2()
        {
            // Check the binary of red with the value of 94 assigned
            Colour c = new Colour();
            c.red = 94;

            Assert.AreEqual<UInt32>(0b01011110, c.red);
        }
